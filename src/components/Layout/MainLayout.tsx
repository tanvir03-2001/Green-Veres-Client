        ...
        <div className="flex items-center justify-between px-4 h-full">
          ...
          <div className="flex items-center space-x-4">
            <button
              ...
              className="relative w-10 h-10 rounded-full bg-green-100 flex items-center justify-center hover:bg-green-200 transition-colors"
            >
            ...
            {isAuthenticated && user ? (
              ...
              <a
                href="/login"
                className="px-4 py-2 text-sm font-semibold text-green-600 hover:text-green-700"
              >
                Login
              </a>
            )}
