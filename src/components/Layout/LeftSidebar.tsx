  ...
  return (
    <aside className="w-64 h-full bg-white border-r border-gray-200 flex-shrink-0 flex flex-col">
      <div className="p-4 flex-1 overflow-y-auto">
        ...
        {/* Quick Links */}
        <div className="mb-4">
          <h3 className="text-xs font-semibold text-gray-500 uppercase px-3 mb-2">দ্রুত লিংক</h3>
      ...
      <div className="border-t border-gray-200 bg-white">
        <div className="flex items-center space-x-3 py-2 px-6 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors">
          ...
          <div>
            <p className="text-sm font-semibold text-gray-900">মিজান রহমান</p>
            <p className="text-xs text-gray-500">@mizanrahman</p>
          </div>
        </div>
      </div>
    </aside>
